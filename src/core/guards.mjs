...
export const ENUMS = {
  ...
  discoveryStatus: ['needs_research', 'ready_for_agent', 'in_progress', 'promoted_to_issue', 'folded_into_issue', 'duplicate', 'rejected', 'resolved_by_existing_code', 'deferred', 'archived'],
  discoverySourceType: ['user_request', 'user_note', 'agent_note', 'github_export', 'github_comment', 'terminal_output', 'code_audit', 'research', 'document', 'screenshot', 'other'],
  containerStatus: ['active', 'archived', 'closed', 'draft', 'paused'],
  rawSourceType: ['user_note', 'agent_note', 'github_export', 'github_comment', 'terminal_output', 'code_audit', 'research', 'document', 'screenshot', 'other'],
  ...
  wikiStatus: ['draft', 'active', 'stable', 'deprecated', 'archived'],
  relationshipType: [
    'belongs_to',
    'contains',
    'derived_from',
