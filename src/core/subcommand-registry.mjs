...
const CONTRACTS = [
  ...
  { command: 'trace', action: 'on', domain: 'system', summary: 'Enable append-only command tracing.', usage: 'mm trace on [--verbose|--level debug] [--json]', readOnly: false, lockScope: DEFAULT_LOCK_SCOPE, roleTags: ['system.trace.write'], dashboard: false, examples: ['mm trace on --verbose', 'mm logging yes'] },
  { command: 'trace', action: 'off', domain: 'system', summary: 'Disable command tracing.', usage: 'mm trace off [--json]', readOnly: false, lockScope: DEFAULT_LOCK_SCOPE, roleTags: ['system.trace.write'], dashboard: false, examples: ['mm trace off', 'mm logging no'] },
  { command: 'trace', action: 'status', domain: 'system', summary: 'Show trace configuration and active inferred session.', usage: 'mm trace status [--json]', readOnly: true, lockScope: null, roleTags: ['system.trace.read'], dashboard: false, examples: ['mm trace status --json', 'mm logging status'] },
  { command: 'trace', action: 'mark', domain: 'system', summary: 'Label subsequent traced command activity.', usage: 'mm trace mark <label> [--json]', readOnly: false, lockScope: DEFAULT_LOCK_SCOPE, roleTags: ['system.trace.write'], dashboard: false, examples: ['mm trace mark "security audit cleanup"'] },
  { command: 'trace', action: 'context', domain: 'system', summary: 'Set, show, or clear optional upstream agent context.', usage: 'mm trace context <set|clear|show> [--json]', readOnly: false, lockScope: DEFAULT_LOCK_SCOPE, roleTags: ['system.trace.write'], dashboard: false, examples: ['mm trace context set --agent codex --label "audit pass"', 'mm trace context clear'] },
  { command: 'trace', action: 'config', domain: 'system', summary: 'Update trace level, timeout, or redaction mode.', usage: 'mm trace config [--level basic|verbose|debug] [--redaction default|none] [--json]', readOnly: false, lockScope: DEFAULT_LOCK_SCOPE, roleTags: ['system.trace.write'], dashboard: false, examples: ['mm trace config --level debug'] },
  { command: 'trace', action: 'sessions', domain: 'system', summary: 'List inferred trace sessions.', usage: 'mm trace sessions [--limit N] [--json]', readOnly: true, lockScope: null, roleTags: ['system.trace.read'], dashboard: false, examples: ['mm trace sessions --json'] },
  { command: 'trace', action: 'show', domain: 'system', summary: 'Show events in one inferred trace session.', usage: 'mm trace show <session-id> [--json]', readOnly: true, lockScope: null, roleTags: ['system.trace.read'], dashboard: false, examples: ['mm trace show trace_... --json'] },
  ...
  { command: 'index', action: 'status', domain: 'system', summary: 'Inspect compact search store state.', usage: 'mm index status [--json]', readOnly: true, lockScope: null, roleTags: ['system.index.read'], dashboard: true, examples: ['mm index status --json'] },
  { command: 'index', action: 'rebuild', domain: 'system', summary: 'Rebuild compact search store artifacts.', usage: 'mm index rebuild [--json]', readOnly: false, lockScope: DEFAULT_LOCK_SCOPE, roleTags: ['system.index.write'], dashboard: false, examples: ['mm index rebuild'] },
  { command: 'index', action: 'stats', domain: 'system', summary: 'Show compact search store file sizes and backend metadata.', usage: 'mm index stats [--json]', readOnly: true, lockScope: null, roleTags: ['system.index.read'], dashboard: true, examples: ['mm index stats --json'] },
  { command: 'index', action: 'terms', domain: 'system', summary: 'Inspect postings for a normalized search term.', usage: 'mm index terms <term> [--limit N] [--json]', readOnly: true, lockScope: null, roleTags: ['system.index.read'], dashboard: false, examples: ['mm index terms boundary --json'] },
  { command: 'index', action: 'chunks', domain: 'system', summary: 'Inspect chunks for a page id or path.', usage: 'mm index chunks --page <page-id-or-path> [--json]', readOnly: true, lockScope: null, roleTags: ['system.index.read'], dashboard: false, examples: ['mm index chunks --page wiki/overview.md --json'] },
  { command: 'index', action: 'explain', domain: 'system', summary: 'Explain search tokens, matched postings, and ranked results.', usage: 'mm index explain <query> [--kind <kind>] [--path <prefix>] [--since 30d|date] [--json]', readOnly: true, lockScope: null, roleTags: ['system.index.read', 'knowledge.search.read'], dashboard: false, examples: ['mm index explain "field boundary" --kind issue --json'] },
  ...
  { command: 'comment', action: 'add', domain: 'knowledge', summary: 'Attach a comment to an issue, discovery, or raw item.', usage: 'mm comment add <issue|discovery|raw-id> <body> [--json]', readOnly: false, lockScope: DEFAULT_LOCK_SCOPE, roleTags: ['knowledge.comment.create'], dashboard: true, examples: ['mm comment add issue_... "Reviewer confirmed this."'] },
  ...
  { command: 'search', action: 'query', domain: 'knowledge', summary: 'Search indexed memory.', usage: 'mm search <query> [--kind <kind>] [--path <prefix>] [--since 30d|date] [--limit N] [--json]', readOnly: true, lockScope: null, roleTags: ['knowledge.search.read'], dashboard: true, examples: ['mm search "approval bug" --json', 'mm search "field boundary" --kind issue --path work/issues --json'] },
  ...
  { command: 'task', action: 'create', domain: 'work', summary: 'Create a numbered task record.', usage: 'mm task create <title> --sprint-id <sprint_id> [--phase-id <phase_id>] [--number N] [--json]', readOnly: false, lockScope: DEFAULT_LOCK_SCOPE, lifecycleEffects: ['task.created'], roleTags: ['work.task.create'], dashboard: true, examples: ['mm task create "Patch guard" --sprint-id sprint_...'] },
  ...
  { command: 'sprint', action: 'create', domain: 'work', summary: 'Create a numbered sprint record.', usage: 'mm sprint create <title> [--number N] --goal <goal> [--json]', readOnly: false, lockScope: DEFAULT_LOCK_SCOPE, lifecycleEffects: ['sprint.created'], roleTags: ['work.sprint.create'], dashboard: true, examples: ['mm sprint create "Audit closeout" --goal "Resolve verified findings"'] },
  { command: 'sprint', action: 'compose', domain: 'work', summary: 'Compose a numbered sprint, phase, and tasks from issues.', usage: 'mm sprint compose <title> --issue-ids a,b [--sprint-number N] [--phase-number N] [--json]', readOnly: false, lockScope: DEFAULT_LOCK_SCOPE, lifecycleEffects: ['sprint.created', 'phase.created', 'task.created'], roleTags: ['work.sprint.compose', 'work.phase.create', 'work.task.create'], dashboard: true, examples: ['mm sprint compose "Bug fix sprint" --issue-ids issue_a,issue_b'] },
  ...
  { command: 'sprint', action: 'update', domain: 'work', summary: 'Update a sprint record.', usage: 'mm sprint update <id> <status> [--goal "..."] [--success-gates "a,b"] [flags] [--json]', readOnly: false, lockScope: DEFAULT_LOCK_SCOPE, lifecycleEffects: ['sprint.updated'], roleTags: ['work.sprint.update'], dashboard: true, examples: ['mm sprint update sprint_... active --note "Started"', 'mm sprint update sprint_... completed --success-gates "all linked tasks have verification evidence,closeout note published"'] },
  { command: 'phase', action: 'create', domain: 'work', summary: 'Create a numbered phase record within a sprint.', usage: 'mm phase create <title> --sprint-id <sprint_id> [--number N] [--json]', readOnly: false, lockScope: DEFAULT_LOCK_SCOPE, lifecycleEffects: ['phase.created'], roleTags: ['work.phase.create'], dashboard: true, examples: ['mm phase create "Fixes" --sprint-id sprint_...'] },
  ...
  { command: 'phase', action: 'update', domain: 'work', summary: 'Update a phase record.', usage: 'mm phase update <id> <status> [--task-ids a,b] [--success-gates "a,b"] [flags] [--json]', readOnly: false, lockScope: DEFAULT_LOCK_SCOPE, lifecycleEffects: ['phase.updated'], roleTags: ['work.phase.update'], dashboard: true, examples: ['mm phase update phase_... active --note "Execution started"', 'mm phase update phase_... completed --success-gates "targeted checks passed,deliverable reviewed"'] },
